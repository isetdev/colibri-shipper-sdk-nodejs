...
/**
 * Creates an instance of Dimensions
 */
class Dimensions extends BaseModel {
    ...
    constructor(obj) {
        ...
        this.width = this.constructor.getValue(obj.width);
        this.height = this.constructor.getValue(obj.height);
        this.length = this.constructor.getValue(obj.length);
    }
